...
*-----------------------------------------
gl metaDataVars (interview__key interview__id id00 EstablishmentName Sub_Sector Region regCode District distCode /*DistrictTypeCode Sub_MetroCode EA_num*/  EZ  Estab_number StreetName Suburb ExactLocation Town Team Supervisor SupervisorContact EnumeratorName EnumContact qtype interview__id)
...
*-----------------------------------------
sort regCode distCode /*DistrictTypeCode Sub_MetroCode EA_num*/  Team EZ  Estab_number
...
duplicates tag regCode distCode /*DistrictTypeCode Sub_MetroCode EA_num*/ EZ  Estab_number, gen(dups1)
