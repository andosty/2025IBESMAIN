# setwd("/srv/shiny-server/2025IBES/")
setwd("C:/2025IBESMAIN/")

#--- Download HQ Data for all interview_status
source("server/Rscripts/Data Download/download HQ data.R", local = T , echo = T)
...
source("server/Rscripts/hqScripts/getOS_Script.R", local = T , echo = F)
cat(currentOs)